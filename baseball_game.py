...
def is_between_100_and_999(user_input_number):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    if int(user_input_number) > 99 and int(user_input_number) < 1000:
        result = True
    else:
        result = False
    # ==================================
...
def is_validated_number(user_input_number):
    ...
    if is_digit(user_input_number) == False:
        result = False
    elif is_between_100_and_999(user_input_number) ==False:
        result = False
    elif len(user_input_number)!=3:
        result = False
    elif is_duplicated_number(user_input_number) ==False:
        result = True
    else:
        result = False
...
def get_not_duplicated_three_digit_number():
    ...
    three_digit= str(get_random_number())
    while is_duplicated_number(three_digit) == True:
        three_digit= str(get_random_number())

    result = int(three_digit)
    # ==================================
    return result
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    user_num = str(user_input_number)
...
def is_yes(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    sign = one_more_input.upper() =="Y" or one_more_input.upper() =="YES"
    if sign:
        result = True
    else:
        result = False
...
def is_no(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    sign = one_more_input.upper() =="N" or one_more_input.upper() =="NO"
    if sign:
        result = True
    else:
        result = False
